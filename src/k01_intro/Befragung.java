...
public class Befragung {
        ...
        public static void main(String[] args) {
                ...
                System.out.println("3. Lernen Täglich? Anzahl:");
                p_i = 100.f * sc.nextInt() / h;
                System.out.println("Anteil: " + p_i + "%");

                System.out.println("4. Gehen am Wochende Feiern? Anzahl:");
                p_i = 100.f * sc.nextInt() / h;
                System.out.println("Anteil: " + p_i + "%");

                System.out.println("5. Wer hat eine Prüfung schon nicht bestanden? Anzahl:");
                p_i = 100.f * sc.nextInt() / h;
                System.out.println("Anteil: " + p_i + "%");

                System.out.println("6. Wer hat an der O-Phase teilgenommen? Anzahl:");
                p_i = 100.f *sc.nextInt() / h;
                System.out.println("Anteil: " + p_i + "%");
