...
public class LoesungDiagonalen extends JFrame {
   ...
   public void meineDiagonalen(Graphics g){
		...
		g.drawLine(x75, y25, x25, y25);//horizontal oben
		g.drawLine(x25, y25, x25, y75);//vertikal links
		g.drawLine(x75, y25, x75, y75);//vertikal rechts

		// Beispiel für Einsatz anderer Farbe
		//g.setColor(Color.RED); // Soll schwarz sein
		g.drawLine(x25, y75, x75, y75);//horizontale unten

		// TODO: rote Diagonale zeichnen
		g.setColor(Color.RED);
		g.drawLine(x75, y75, x25, y25);//Diagonale
